...
## Generated on : Thu Mar 14 21:04:55 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\dev\build\4_matlab\62_mex_Edge_Detection\codegen\lib\sobel
ARCH                      = win64
...
INCLUDES_BUILDINFO = $(START_DIR);C:\dev\build\4_matlab\62_MEX~1;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\sobel_data.c $(START_DIR)\sobel_initialize.c $(START_DIR)\sobel_terminate.c $(START_DIR)\sobel.c $(START_DIR)\conv2.c $(START_DIR)\conv2AXPY.c $(START_DIR)\sqrt.c $(START_DIR)\sobel_emxutil.c $(START_DIR)\sobel_emxAPI.c
...
OBJS = sobel_data.obj sobel_initialize.obj sobel_terminate.obj sobel.obj conv2.obj conv2AXPY.obj sqrt.obj sobel_emxutil.obj sobel_emxAPI.obj
...
{C:\dev\build\4_matlab\62_mex_Edge_Detection}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\dev\build\4_matlab\62_mex_Edge_Detection}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
