...
echo EMC_COMPILER=msvc150>> visionRecovertformCodeGeneration_kernel_mex.mki
echo EMC_CONFIG=optim>> visionRecovertformCodeGeneration_kernel_mex.mki
"C:\MATLAB\R2018b\bin\win64\gmake" -j 1 -B -f visionRecovertformCodeGeneration_kernel_mex.mk
