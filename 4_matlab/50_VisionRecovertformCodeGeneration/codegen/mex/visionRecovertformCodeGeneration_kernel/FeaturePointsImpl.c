  ...
  emxArray_real32_T *location)
{
  ...
  if (!p) {
    emlrtErrorWithMessageIdR2018a(&b_st, &lh_emlrtRTEI,
  ...
  if (!size_check(location)) {
    emlrtErrorWithMessageIdR2018a(&b_st, &vh_emlrtRTEI,
  ...
  *metric)
{
  ...
  if (!p) {
    emlrtErrorWithMessageIdR2018a(&c_st, &th_emlrtRTEI,
      "Coder:toolbox:ValidateattributesexpectedNonNaN",
  ...
  p = b_all(metric);
  if (!p) {
    emlrtErrorWithMessageIdR2018a(&c_st, &uh_emlrtRTEI,
      "Coder:toolbox:ValidateattributesexpectedFinite",
