...
static emlrtRTEInfo ai_emlrtRTEI = { 19,/* lineNo */
  5,                                   /* colNo */
  "error",                             /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\shared\\coder\\coder\\+coder\\+internal\\error.m"/* pName */
};

/* Function Definitions */
void b_error(const emlrtStack *sp)
{
  emlrtErrorWithMessageIdR2018a(sp, &ai_emlrtRTEI, "MATLAB:nomem",
    "MATLAB:nomem", 0);
}
...
void c_error(const emlrtStack *sp, int32_T varargin_2)
{
  ...
  emlrtErrorWithMessageIdR2018a(sp, &ai_emlrtRTEI,
