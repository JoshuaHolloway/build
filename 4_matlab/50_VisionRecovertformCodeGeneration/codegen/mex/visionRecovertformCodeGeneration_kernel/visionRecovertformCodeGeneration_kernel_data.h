 ...
 *
 * visionRecovertformCodeGeneration_kernel_data.h
 *
 * Code generation for function 'visionRecovertformCodeGeneration_kernel_data'
 *
 */

#ifndef VISIONRECOVERTFORMCODEGENERATION_KERNEL_DATA_H
#define VISIONRECOVERTFORMCODEGENERATION_KERNEL_DATA_H
...
extern const real_T dv0[3];
extern const char_T cv0[15];
extern emlrtRSInfo nm_emlrtRSI;
extern emlrtRSInfo pm_emlrtRSI;

#endif

/* End of code generation (visionRecovertformCodeGeneration_kernel_data.h) */
