...
static emlrtRSInfo lh_emlrtRSI = { 53, /* lineNo */
  "svd",                               /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pathName */
};

static emlrtRSInfo mh_emlrtRSI = { 78, /* lineNo */
  "svd",                               /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pathName */
};

static emlrtRSInfo nh_emlrtRSI = { 83, /* lineNo */
  "svd",                               /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pathName */
};

static emlrtRSInfo oh_emlrtRSI = { 105,/* lineNo */
  "svd",                               /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pathName */
};

static emlrtRSInfo ph_emlrtRSI = { 205,/* lineNo */
  "xgesdd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesdd.m"/* pathName */
};

static emlrtRSInfo qh_emlrtRSI = { 175,/* lineNo */
  "xgesdd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesdd.m"/* pathName */
};

static emlrtRSInfo rh_emlrtRSI = { 64, /* lineNo */
  "xgesdd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesdd.m"/* pathName */
};

static emlrtRSInfo sh_emlrtRSI = { 57, /* lineNo */
  "xgesdd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesdd.m"/* pathName */
};

static emlrtRSInfo th_emlrtRSI = { 54, /* lineNo */
  "xgesdd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesdd.m"/* pathName */
};

static emlrtRSInfo ai_emlrtRSI = { 28, /* lineNo */
  "xgesvd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pathName */
};

static emlrtRSInfo bi_emlrtRSI = { 193,/* lineNo */
  "xgesvd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pathName */
};

static emlrtRSInfo ci_emlrtRSI = { 171,/* lineNo */
  "xgesvd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pathName */
};
...
static emlrtRSInfo ei_emlrtRSI = { 107,/* lineNo */
  "xgesvd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pathName */
};

static emlrtRSInfo fi_emlrtRSI = { 56, /* lineNo */
  "xgesvd",                            /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pathName */
};

static emlrtRTEInfo qf_emlrtRTEI = { 78,/* lineNo */
  66,                                  /* colNo */
  "svd",                               /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pName */
};

static emlrtRTEInfo rf_emlrtRTEI = { 78,/* lineNo */
  9,                                   /* colNo */
  "svd",                               /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pName */
};

static emlrtRTEInfo sf_emlrtRTEI = { 28,/* lineNo */
  33,                                  /* colNo */
  "xgesvd",                            /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pName */
};

static emlrtRTEInfo tf_emlrtRTEI = { 53,/* lineNo */
  5,                                   /* colNo */
  "svd",                               /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\svd.m"/* pName */
};

static emlrtRTEInfo uf_emlrtRTEI = { 28,/* lineNo */
  5,                                   /* colNo */
  "xgesvd",                            /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgesvd.m"/* pName */
};
         ...
         real32_T s_data[], int32_T s_size[1], real32_T V[25])
{
  ...
  emxInit_real32_T(sp, &b_A, 2, &qf_emlrtRTEI, true);
  st.site = &lh_emlrtRSI;
  m = A->size[0];
  ...
  b_A->size[0] = A->size[0];
  b_A->size[1] = 5;
  emxEnsureCapacity_real32_T(&b_st, b_A, i18, &qf_emlrtRTEI);
  minnm = A->size[0] * A->size[1];
  for (i18 = 0; i18 < minnm; i18++) {
    b_A->data[i18] = A->data[i18];
  }

  emxInit_real32_T(&b_st, &Utmp, 2, &vf_emlrtRTEI, true);
  i18 = Utmp->size[0] * Utmp->size[1];
  Utmp->size[0] = A->size[0];
  Utmp->size[1] = A->size[0];
  emxEnsureCapacity_real32_T(&b_st, Utmp, i18, &rf_emlrtRTEI);
  ...
  if (info > 0) {
    ...
    b_A->size[0] = A->size[0];
    b_A->size[1] = 5;
    emxEnsureCapacity_real32_T(&c_st, b_A, i18, &sf_emlrtRTEI);
    minnm = A->size[0] * A->size[1];
    for (i18 = 0; i18 < minnm; i18++) {
      b_A->data[i18] = A->data[i18];
    }
    ...
    U->size[0] = A->size[0];
    U->size[1] = minnm;
    emxEnsureCapacity_real32_T(&c_st, U, i18, &uf_emlrtRTEI);
    s_size[0] = minnm;
    if (A->size[0] != 0) {
    ...
    emxEnsureCapacity_real32_T(&st, U, i18, &tf_emlrtRTEI);
    i18 = U->size[0] * U->size[1];
