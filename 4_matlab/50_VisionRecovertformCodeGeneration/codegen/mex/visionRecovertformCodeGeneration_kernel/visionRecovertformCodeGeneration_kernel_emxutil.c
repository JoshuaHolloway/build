...
static void emxInitStruct_cell_wrap_26(const emlrtStack *sp, cell_wrap_26
...
static void emxInitStruct_cell_wrap_26(const emlrtStack *sp, cell_wrap_26
  *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real32_T(sp, &pStruct->f1, 2, srcLocation, doPush);
}

void c_emxFreeStruct_vision_internal(vision_internal_SURFPoints_cg *pStruct)
{
  emxFree_real32_T(&pStruct->pLocation);
  emxFree_real32_T(&pStruct->pMetric);
  emxFree_real32_T(&pStruct->pScale);
  emxFree_int8_T(&pStruct->pSignOfLaplacian);
...
void c_emxInitStruct_vision_internal(const emlrtStack *sp,
  ...
  boolean_T doPush)
{
  emxInit_real32_T(sp, &pStruct->pLocation, 2, srcLocation, doPush);
  emxInit_real32_T(sp, &pStruct->pMetric, 1, srcLocation, doPush);
  emxInit_real32_T(sp, &pStruct->pScale, 1, srcLocation, doPush);
  emxInit_int8_T(sp, &pStruct->pSignOfLaplacian, 1, srcLocation, doPush);
  emxInit_real32_T(sp, &pStruct->pOrientation, 1, srcLocation, doPush);
}
...
void emxInitMatrix_cell_wrap_26(const emlrtStack *sp, cell_wrap_26 pMatrix[2],
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInitStruct_cell_wrap_26(sp, &pMatrix[0], srcLocation, doPush);
  emxInitStruct_cell_wrap_26(sp, &pMatrix[1], srcLocation, doPush);
}
...
/* End of code generation (visionRecovertformCodeGeneration_kernel_emxutil.c) */
