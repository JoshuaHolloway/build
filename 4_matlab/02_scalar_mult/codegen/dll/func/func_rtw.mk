...
## Generated on : Sun Feb 17 19:16:52 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\dev\build\4_matlab\02_mat_mult\codegen\dll\func
ARCH                      = win64
...
INCLUDES_BUILDINFO = $(START_DIR);C:\dev\build\4_matlab\02_MAT~2;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
{C:\dev\build\4_matlab\02_mat_mult}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\dev\build\4_matlab\02_mat_mult}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
