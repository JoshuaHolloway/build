 ...
 * gaussianFilter.c
 *
 * Code generation for function 'gaussianFilter'
 *
 */
...
static emlrtRSInfo emlrtRSI = { 15,    /* lineNo */
  "gaussianFilter",                    /* fcnName */
  "C:\\dev\\build\\4_matlab\\71_using_C_Cpp_Code_with_MATLAB\\gaussianFilter.m"/* pathName */
};

static emlrtRSInfo b_emlrtRSI = { 35,  /* lineNo */
  "fprintf",                           /* fcnName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\lib\\matlab\\iofun\\fprintf.m"/* pathName */
};

static emlrtMCInfo emlrtMCI = { 60,    /* lineNo */
  18,                                  /* colNo */
  "fprintf",                           /* fName */
  "C:\\MATLAB\\R2018b\\toolbox\\eml\\lib\\matlab\\iofun\\fprintf.m"/* pName */
};
...
void gaussianFilter(const emlrtStack *sp, real_T x[777600], int32_T imsize[2],
                    real_T y[777600])
{
  const mxArray *b_y;
  const mxArray *m0;
  ...
  static const char_T b_u[28] = { 'R', 'u', 'n', 'n', 'i', 'n', 'g', ' ', 'C',
    'u', 's', 't', 'o', 'm', ' ', 'C', '-', 'C', 'o', 'd', 'e', '.', '.', '.',
    '\\', 'n', '\\', 'n' };
  ...
  emlrtInitCharArrayR2013a(&b_st, 28, m2, &b_u[0]);
  emlrtAssign(&d_y, m2);
...
/* End of code generation (gaussianFilter.c) */
