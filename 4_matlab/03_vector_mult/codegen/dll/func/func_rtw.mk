...
## Generated on : Sun Feb 17 19:59:33 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\dev\build\4_matlab\03_vector_mult\codegen\dll\func
ARCH                      = win64
...
INCLUDES_BUILDINFO = $(START_DIR);C:\dev\build\4_matlab\03_VEC~1;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
OBJS = func_initialize.obj func_terminate.obj func.obj
...
{C:\dev\build\4_matlab\03_vector_mult}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\dev\build\4_matlab\03_vector_mult}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
