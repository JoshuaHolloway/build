...
## Generated on : Mon Feb 18 13:23:52 2019
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\dev\build\4_matlab\20_image_filtering\codegen\dll\func
ARCH                      = win64
...
INCLUDES_BUILDINFO = $(START_DIR);C:\dev\build\4_matlab\20_IMA~1;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\func_data.c $(START_DIR)\func_initialize.c $(START_DIR)\func_terminate.c $(START_DIR)\func.c $(START_DIR)\conv2AXPY.c
...
OBJS = func_data.obj func_initialize.obj func_terminate.obj func.obj conv2AXPY.obj
...
{C:\dev\build\4_matlab\20_image_filtering}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\dev\build\4_matlab\20_image_filtering}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
