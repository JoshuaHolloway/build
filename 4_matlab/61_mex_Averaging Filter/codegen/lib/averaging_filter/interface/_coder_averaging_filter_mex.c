 ...
 * File: _coder_averaging_filter_mex.c
 *
...
static void averaging_filter_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T
  ...
  nrhs, const mxArray *prhs[1])
{
  ...
  /* Call the function. */
  averaging_filter_api(prhs, nlhs, outputs);
...
/*
 * File trailer for _coder_averaging_filter_mex.c
 *
 * [EOF]
 */
