...
static void main_averaging_filter(void);
...
static void main_averaging_filter(void)
{
  ...
  /* Initialize function 'averaging_filter' input arguments. */
  /* Initialize function input argument 'x'. */
  /* Call the entry-point 'averaging_filter'. */
  argInit_1x1024_real_T(dv1);
  averaging_filter(dv1, y);
}
